...
echo options TYPE_HANDLED_SOURCE_DIR .. .\aos_bhp\atp_core\impl\data_storage\targets\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_core\impl\data_storage\tracks\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_core\impl\test_atp\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\data_storage\tracks\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\data_storage\tsetup\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\dmi_comm\dmi_handler\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\event_handler\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\input_output\btm_handler\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\kernel\message_handler\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\position\decode\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\position\odometry\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\position\position\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\radio_comm\radio_handler\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_bhp\impl\supervision\brake\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\aos_allocator\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\aos_template_library\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\aos_template_library\old_copied_from_etcs\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\bds_sim\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\coding_templates\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\serialization\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\simulation\cod_sim\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\simulation\common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\simulation\opc_sim\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\simulation\vioh_sim\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atc\impl\vfw_sim\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\atp_core\impl\support\cross_compare\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .. .\aos_bhp\COD_IF\ >> commands.tmp
