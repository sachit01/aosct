  ...
  namespace Supv
  {
    ...
    */
    ...
    private:
      ...
      */
      void addSupvSpeedAndPrimaryTargets(void) const;
      ...
      */
      ...
      /** update warning speeds (FW,SW,SB and EB) for all the targets
      *
      * Implements the updateWarningSpeedsForTargets() function.
      ...
      *
      */
      void updateCurveSpeedsForTargets() const;
      ...
      */
      static const uint32_t maxSizeCurveVectors = 10U;
