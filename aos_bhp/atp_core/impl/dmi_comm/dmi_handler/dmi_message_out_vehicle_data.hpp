#ifndef DMIMessageOutVehicleData_hpp
#define DMIMessageOutVehicleData_hpp
/*******************************************************************************
*
...
namespace ATP
{
  ...
  {
    /**
    * DMIMessageOutVehicleData is a creator for the outgoing Vehicle Data DMIMessage
    */
    class DMIMessageOutVehicleData : public AbstractDMIMessageOut
    {

    public:
      /**
      * Constructor for a creator of a outgoing vehicle data DMIMessage
      */
      DMIMessageOutVehicleData();
      ...
      */
      ...
      /**
      * Invalidates the outgoing message and clears the outgoing vehicle data (shall be called once per ATP execution-cycle)
      */
    ...
    private:
      ...
      */
      ...
      /**
      * Vehicle Data received or send to DMI
      */
      VehicleDataBlock vehicleData[maxVehicleCount + 1U];
    };
  }
}
#endif
