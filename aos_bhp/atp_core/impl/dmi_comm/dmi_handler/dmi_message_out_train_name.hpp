#ifndef DMIMessageOutTrainName_hpp
#define DMIMessageOutTrainName_hpp
/*******************************************************************************
*
...
namespace ATP
{
  ...
  {
    /**
    * DMIMessageOutTrainName is a creator for the outgoing Train Name DMIMessage.
    */
    class DMIMessageOutTrainName : public AbstractDMIMessageOut
    {

    public:
      /**
      * Constructor for a creator of a outgoing Train Name DMIMessage.
      */
      DMIMessageOutTrainName();
