#ifndef RadioMessageInStopTrain_hpp
#define RadioMessageInStopTrain_hpp
/*******************************************************************************
*
...
namespace ATP
{
  ...
  {
    /**
    * RadioMessageInStopTrain is a parser for the incoming StopTrain message
    */
    class RadioMessageInStopTrain : public AbstractRadioMessageIn
    {
    public:
      /**
      * Constructor for RadioMessageInStopTrain which is a parser for the incoming StopTrain message
      */
      RadioMessageInStopTrain();
