#ifndef LocoIO_EventIDs_hpp
#define LocoIO_EventIDs_hpp
/*******************************************************************************
*
...
namespace ATP
{
   namespace IO
   {
      ...
      */
      static const uint16_t eventIdErrHiRailConfigInvalidState = 0x01U;
      static const uint16_t eventIdErrHiRailConfigRoadTransitionState = 0x02U;
