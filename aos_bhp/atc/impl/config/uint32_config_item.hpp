#ifndef Uint32ConfigItem_hpp
#define Uint32ConfigItem_hpp
/*******************************************************************************
*
...
*
*  DESCRIPTION:
*  Declaration for Uint32ConfigItem class.
*
******************************************************************************/
...
namespace ATC
{
  /** uint32 config item class, derived from BaseConfigItem.
  *
  * The derived class Uint32ConfigItem shall be used to store config items with a value of type uint32_t.
  * It implements the abstract methods from BaseConfigItem to get and write an uint32_t value.
  *
  */
  class Uint32ConfigItem : public BaseConfigItem
  {
  public:
    ...
    *
    */
    Uint32ConfigItem(const ConfigIdType id, const char_t * const name, const char_t * const desc, const char_t * const unit,
    ...
    */
    ...
    /**
    * Checks the range of the given value and if valid, sets the item's value
    *
    * @param[in] val  The value to be set as the new item value
    *
    * @return True if the argument is within range
    */
    ...
    */
    uint32_t getDefault(void) const;
#endif
  ...
  private:
    ...
    */
    ...
    /** Value
    *
    * The uint32_t value of the item
    */
    uint32_t value;
    ...
    */
    ...
    /** Default Value
    *
    * The uint32_t default value of the item
    */
