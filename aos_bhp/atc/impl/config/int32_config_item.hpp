#ifndef Int32ConfigItem_hpp
#define Int32ConfigItem_hpp
/*******************************************************************************
*
...
*
*  DESCRIPTION: 
*  Declaration for Int32ConfigItem class.
*
******************************************************************************/
...
namespace ATC
{
  /** int32 config item class, derived from BaseConfigItem.
  *
  * The derived class Int32ConfigItem shall be used to store config items with a value of type int32_t.
  * It implements the abstract methods from BaseConfigItem to get and write an int32_t value.
  *
  */
  class Int32ConfigItem : public BaseConfigItem
  {
  public:
    ...
    */
    Int32ConfigItem(const ConfigIdType id, const char_t * const name, const char_t * const desc, const char_t * const unit,
  ...
  private:
    ...
    */
    ...
    /** Default Value
    *
    * The int32_t default value of the item
    */
