#ifndef Uint16ConfigItem_hpp
#define Uint16ConfigItem_hpp
/*******************************************************************************
*
...
*
*  DESCRIPTION:
*  Declaration for Uint16ConfigItem class.
*
******************************************************************************/
...
namespace ATC
{
  /** uint16 config item class, derived from BaseConfigItem.
  *
  * The derived class Uint16ConfigItem shall be used to store config items with a value of type uint16_t.
  * It implements the abstract methods from BaseConfigItem to get and write an uint16_t value.
  *
  */
  class Uint16ConfigItem : public BaseConfigItem
  {
  public:
    ...
    *
    */
    Uint16ConfigItem(const ConfigIdType id, const char_t * const name, const char_t * const desc, const char_t * const unit,
    ...
    */
    uint16_t getDefault(void) const;
#endif
  ...
  private:
    ...
    */
    ...
    /** Value
    *
    * The uint16_t value of the item
    */
    uint16_t value;
    ...
    */
    ...
    /** Default Value
    *
    * The uint16_t default value of the item
    */
