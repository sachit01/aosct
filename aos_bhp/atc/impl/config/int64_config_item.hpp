#ifndef Int64ConfigItem_hpp
#define Int64ConfigItem_hpp
/*******************************************************************************
*
...
*
*  DESCRIPTION: 
*  Declaration for Int64ConfigItem class.
*
******************************************************************************/
...
namespace ATC
{
  /** int64 config item class, derived from BaseConfigItem.
  *
  * The derived class Int64ConfigItem shall be used to store config items with a value of type int64_t.
  * It implements the abstract methods from BaseConfigItem to get and write an int64_t value.
  *
  */
  class Int64ConfigItem : public BaseConfigItem
  {
  public:
    ...
    *  
    */
    Int64ConfigItem(const ConfigIdType id, const char_t * const name, const char_t * const desc, const char_t * const unit,
  ...
  private:
    ...
    */
    ...
    /** Default Value
    *
    * The int64_t default value of the item
    */
