#ifndef Uint8ConfigItem_hpp
#define Uint8ConfigItem_hpp
/*******************************************************************************
*
...
*
*  DESCRIPTION:
*  Declaration for Uint8ConfigItem class.
*
******************************************************************************/
...
namespace ATC
{
  /** uint8 config item class, derived from BaseConfigItem.
  *
  * The derived class Uint8ConfigItem shall be used to store config items with a value of type uint8_t.
  * It implements the abstract methods from BaseConfigItem to get and write an uint8_t value.
  *
  */
  class Uint8ConfigItem : public BaseConfigItem
  {
  public:
    /**
    ...
    *
    */
    Uint8ConfigItem(const ConfigIdType id, const char_t * const name, const char_t * const desc, const char_t * const unit,
  ...
  private:
    ...
    */
    ...
    /** Default Value
    *
    * The uint8_t default value of the item
    */
