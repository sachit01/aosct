 ...
 *                      %created_by:    jkrupp %
 *                      %version:       11 %
 *                      %date_created:  2014-01-07 16:09 %
 **********************************************************************
 *
 *  Revision    Date        Name        Description
 *  10          2013/06/26  jkrupp      delete datatype TIME because of inconsistence and FlexLint warning
 *
...
#if defined(SPL_PLATFORM_PC_GNU) || (defined(SPL_PLATFORM_VCU) && !defined(SPL_BS_TBSW))
